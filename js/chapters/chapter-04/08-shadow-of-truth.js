...
function hud(label){return `<div class="topbar ch4-p8-topbar"><span id="${label}"></span><div class="hud"><button class="icon ch4-p8-save" type="button" aria-label="Save game">💾</button><button class="icon ch4-p8-menu" type="button" aria-label="Game menu">☰<i class="journal-alert" aria-hidden="true"></i></button></div></div>`}
function progressMarkup(){return '<div class="ch4-p8-progress" aria-label="Phase progress"><span class="ch4-p8-progress-text">0%</span><div><i class="ch4-p8-progress-fill"></i></div></div>'}
function scene(id,image,label,extra=""){return `<section id="${id}" class="screen ch4-p8-scene ${extra}"><img class="scene" src="${image}" alt=""><div class="ch4-p8-shade"></div>${hud(label)}<div id="${id}Scene" class="ch4-p8-label"></div><div id="${id}Objective" class="ch4-p8-objective"></div><div id="${id}Dialogue" class="dialogue ch4-p4-dialogue ch4-p8-dialogue hidden"></div><button id="${id}Action" class="primary ch4-p8-action" type="button" hidden></button>${progressMarkup()}</section>`}
function inject(){
