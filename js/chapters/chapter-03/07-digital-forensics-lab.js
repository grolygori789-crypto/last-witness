/* LAST WITNESS - Chapter III / Phase VIII: The Mirror Remembers 0.11.2 */
(function(){
"use strict";
if(window.LastWitnessPhase8?.version==="0.11.2")return;

const BUILD="0.11.2";
const CARD="chapter3Phase8Card";
const SCREEN="chapter3DigitalForensicsLab";
const SCREENS=new Set([CARD,SCREEN]);
const IMAGE="assets/images/chapter-03/phase-08/digital-forensics-lab.png?v=0112";
...
function installPortraits(){
 try{
  ...
  const expanded=Object.assign({},current,{
   restrained_amusement:CHERYL_BASE+"restrained_amusement.png?v=0112",
   professional_fluster:CHERYL_BASE+"professional_fluster.png?v=0112",
   softened_professional:CHERYL_BASE+"softened_professional.png?v=0112",
   focused_command:CHERYL_BASE+"focused_command.png?v=0112"
  });
...
<audio id="ch3P8Ambience" preload="auto" loop><source src="${AUDIO_BASE}secure-mirror-lab-loop.webm?v=0112" type="audio/webm"><source src="${AUDIO_BASE}secure-mirror-lab-loop.mp3?v=0112" type="audio/mpeg"></audio>
<audio id="ch3P8Score" preload="auto" loop><source src="${AUDIO_BASE}mirror-analysis-score-loop.webm?v=0112" type="audio/webm"><source src="${AUDIO_BASE}mirror-analysis-score-loop.mp3?v=0112" type="audio/mpeg"></audio>
<audio id="ch3P8SfxAccess" preload="auto" src="${AUDIO_BASE}sfx/mirror-access-granted.wav?v=0112"></audio><audio id="ch3P8SfxLock" preload="auto" src="${AUDIO_BASE}sfx/event-lock.wav?v=0112"></audio><audio id="ch3P8SfxTrust" preload="auto" src="${AUDIO_BASE}sfx/trust-layer-match.wav?v=0112"></audio><audio id="ch3P8SfxAnomaly" preload="auto" src="${AUDIO_BASE}sfx/wrapper-anomaly-reveal.wav?v=0112"></audio><audio id="ch3P8SfxWarning" preload="auto" src="${AUDIO_BASE}sfx/privilege-decay-warning.wav?v=0112"></audio><audio id="ch3P8SfxSevered" preload="auto" src="${AUDIO_BASE}sfx/session-severed.wav?v=0112"></audio><audio id="ch3P8SfxSnapshot" preload="auto" src="${AUDIO_BASE}sfx/forensic-snapshot-captured.wav?v=0112"></audio><audio id="ch3P8SfxQuery" preload="auto" src="${AUDIO_BASE}sfx/mirror-query-accepted.wav?v=0112"></audio></section>
...
function showPhase9Fallback(){stopAudio(true);const s=gs();if(!s)return;s.screen="chapter3Wip";const c=copy(),title=$("#chapter3WipTitle"),text=$("#chapter3WipText"),btn=$("#chapter3WipReturnTitle");if(title)title.textContent=c.phase9Title;if(text)text.textContent=c.phase9Text;if(btn)btn.textContent=tr("Return to Title","กลับหน้าแรก");safeShow("chapter3Wip")}
