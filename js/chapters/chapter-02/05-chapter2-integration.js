/* LAST WITNESS — Chapter II / Chapter III Production Integration 0.5.2
...
(function () {
  ...
  function ensureProductionRuntime() {
    ...
    addStylesheetOnce("css/chapter-03.css?v=052", "lwChapter03Style");
    runtimePromise = loadScriptOnce(
      "js/engine/11-production-stabilization.js?v=052",
      "lwProductionStabilizationScript"
    ).then(() => loadScriptOnce(
      "js/chapters/chapter-03/01-title-phase1.js?v=052",
      "lwChapter03Script"
    )).catch((error) => {
