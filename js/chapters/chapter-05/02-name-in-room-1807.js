...
function inject(){
 ...
 <audio id="ch5P2Reveal" preload="auto" src="${AUDIO}kavin-reveal.wav?v=0228c5p2r1"></audio>`);
...
function activateMonitorAction(){const p=phaseState();if(p.closingComplete){completePhase();return}if(p.attributionComplete){if(!p.narinContactComplete)openNarin();return}openRecon()}
