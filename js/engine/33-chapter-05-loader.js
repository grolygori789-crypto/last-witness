/* LAST WITNESS - Chapter V Production Loader 0.22.19-c5b26
...
function install(){
 ...
 return script("js/chapters/chapter-05/01-return-to-bangkok.js?v=0228c5p1r10","lwChapter05Phase01Script",()=>Boolean(window.LastWitnessChapter5Phase1?.version==="0.22.8-c5p1r10"&&window.LastWitnessChapter5Phase1?.installed))
  ...
  .then(()=>script("js/chapters/chapter-05/02-name-in-room-1807.js?v=0240c5p2r16","lwChapter05Phase02Script",()=>Boolean(window.LastWitnessChapter5Phase2?.version==="0.22.19-c5p2r16"&&window.LastWitnessChapter5Phase2?.installed)))
