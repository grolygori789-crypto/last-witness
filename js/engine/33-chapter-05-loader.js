/* LAST WITNESS - Chapter V Production Loader 0.22.10-c5b15
 * Historical 0.4.x repair logic remains retired. This file owns the scoped
 * Chapter V production extensions under base Runtime 0.22.10.
 */
(function(){
"use strict";
const VERSION="0.22.10-c5b15";
...
function install(){
 ...
 return script("js/chapters/chapter-05/01-return-to-bangkok.js?v=0228c5p1r10","lwChapter05Phase01Script",()=>Boolean(window.LastWitnessChapter5Phase1?.version==="0.22.8-c5p1r10"&&window.LastWitnessChapter5Phase1?.installed))
  ...
  .then(()=>{try{window.LastWitnessChapter5PoliceTimeCue.install?.()}catch(_){};return stylesheetAsync("css/chapter-05-phase-02.css?v=0230c5p2r6","lwChapter05Phase02Style")})
  .then(()=>script("js/chapters/chapter-05/02-name-in-room-1807.js?v=0230c5p2r6","lwChapter05Phase02Script",()=>Boolean(window.LastWitnessChapter5Phase2?.version==="0.22.10-c5p2r6"&&window.LastWitnessChapter5Phase2?.installed)))
  .then(()=>{try{window.LastWitnessChapter5Phase2.install?.()}catch(_){};return script("js/engine/37-ch5p2-hidden-case-extension.js?v=0230c5h2","lwChapter05Phase02HiddenCaseScript",()=>Boolean(window.LastWitnessChapter5Phase2HiddenCase?.version==="0.22.10-c5h2"&&window.LastWitnessChapter5Phase2HiddenCase?.installed))})
  .then(()=>{try{window.LastWitnessChapter5Phase2HiddenCase.install?.()}catch(_){};return script("js/engine/34-chapter-05-owner-walkthrough.js?v=0228c5w3","lwChapter05OwnerWalkthroughScript",()=>Boolean(window.LastWitnessChapter5OwnerWalkthrough?.version==="0.22.8-c5w3"&&window.LastWitnessChapter5OwnerWalkthrough?.installed))})
