/* LAST WITNESS - Chapter V Production Loader 0.22.7-c5b1
...
function install(){
 stylesheet("css/chapter-05-phase-01.css?v=0227c5p1","lwChapter05Phase01Style");
 return script("js/chapters/chapter-05/01-return-to-bangkok.js?v=0227c5p1","lwChapter05Phase01Script",()=>Boolean(window.LastWitnessChapter5Phase1?.version==="0.22.7-c5p1"&&window.LastWitnessChapter5Phase1?.installed))
  .then(()=>{try{window.LastWitnessChapter5Phase1.install?.()}catch(_){}})
  .catch(error=>console.error("LAST WITNESS Chapter V Phase I failed to load",error))
}
