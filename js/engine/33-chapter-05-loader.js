/* LAST WITNESS - Chapter V Production Loader 0.22.16-c5b22
 * Historical 0.4.x repair logic remains retired. This file owns the scoped
 * Chapter V production extensions under base Runtime 0.22.16.
 */
(function(){
"use strict";
const VERSION="0.22.16-c5b22";
...
function install(){
 ...
 return script("js/chapters/chapter-05/01-return-to-bangkok.js?v=0228c5p1r10","lwChapter05Phase01Script",()=>Boolean(window.LastWitnessChapter5Phase1?.version==="0.22.8-c5p1r10"&&window.LastWitnessChapter5Phase1?.installed))
  ...
  .then(()=>{try{window.LastWitnessChapter5PoliceTimeCue.install?.()}catch(_){};return stylesheetAsync("css/chapter-05-phase-02.css?v=0236c5p2r12","lwChapter05Phase02Style")})
  .then(()=>script("js/chapters/chapter-05/02-name-in-room-1807.js?v=0236c5p2r12","lwChapter05Phase02Script",()=>Boolean(window.LastWitnessChapter5Phase2?.version==="0.22.16-c5p2r12"&&window.LastWitnessChapter5Phase2?.installed)))
