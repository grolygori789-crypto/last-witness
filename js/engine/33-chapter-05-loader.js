/* LAST WITNESS - Chapter V Production Loader 0.22.8-c5b9
...
function install(){
 ...
 return script("js/chapters/chapter-05/01-return-to-bangkok.js?v=0228c5p1r10","lwChapter05Phase01Script",()=>Boolean(window.LastWitnessChapter5Phase1?.version==="0.22.8-c5p1r10"&&window.LastWitnessChapter5Phase1?.installed))
  ...
  .then(()=>{try{window.LastWitnessChapter5PoliceTimeCue.install?.()}catch(_){};return script("js/engine/34-chapter-05-owner-walkthrough.js?v=0228c5w3","lwChapter05OwnerWalkthroughScript",()=>Boolean(window.LastWitnessChapter5OwnerWalkthrough?.version==="0.22.8-c5w3"&&window.LastWitnessChapter5OwnerWalkthrough?.installed))})
