/* LAST WITNESS - Chapter V Production Loader 0.22.8-c5b6
...
function install(){
 stylesheet("css/chapter-05-phase-01.css?v=0228c5p1r9","lwChapter05Phase01Style");
 return script("js/chapters/chapter-05/01-return-to-bangkok.js?v=0228c5p1r9","lwChapter05Phase01Script",()=>Boolean(window.LastWitnessChapter5Phase1?.version==="0.22.8-c5p1r9"&&window.LastWitnessChapter5Phase1?.installed))
