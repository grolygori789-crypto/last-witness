/* LAST WITNESS — Legacy Compatibility Shim + Chapter IV Bootstrap 0.14.3
...
script("js/chapters/chapter-04/01-afterimage.js?v=0132","lwChapter04Phase01Script",()=>Boolean(window.LastWitnessChapter4Phase1))
 .then(()=>{stylesheet("css/chapter-04-phase-02.css?v=0143","lwChapter04Phase02Style");return script("js/chapters/chapter-04/02-jakarta-arrival.js?v=0143","lwChapter04Phase02Script",()=>Boolean(window.LastWitnessChapter4Phase2))})
