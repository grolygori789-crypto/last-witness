/* LAST WITNESS - Legacy Compatibility Shim + Runtime Bootstrap 0.17.11
 ...
 * Character notification contract 0.17.11 preserves the Police and Arman repairs
 * and adds the scoped Adrian discovery and Phase VII HUD red-dot repair.
 */
(function(){
"use strict";
...
script("js/engine/15-thai-localization.js?v=0152","lwThaiLocalizationScript",()=>Boolean(window.LastWitnessThaiLocalization?.version==="0.15.2"&&window.LastWitnessThaiLocalization?.installed))
 ...
 .then(()=>script(
  "js/engine/21-character-notification-contract.js?v=01711",
  "lwCharacterNotificationContractScript",
  ()=>Boolean(window.LastWitnessCharacterNotificationContract?.version==="0.17.11"&&window.LastWitnessCharacterNotificationContract?.installed)
