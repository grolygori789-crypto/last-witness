/* LAST WITNESS - Legacy Compatibility Shim + Runtime Bootstrap 0.16.2
...
script("js/engine/15-thai-localization.js?v=0152","lwThaiLocalizationScript",()=>Boolean(window.LastWitnessThaiLocalization?.version==="0.15.2"&&window.LastWitnessThaiLocalization?.installed))
 ...
 .then(()=>{
  stylesheet("css/chapter-04-phase-03.css?v=0162","lwChapter04Phase03Style");
  return script("js/chapters/chapter-04/03-packet-provenance.js?v=0162","lwChapter04Phase03Script",()=>Boolean(window.LastWitnessChapter4Phase3?.version==="0.16.2"))
