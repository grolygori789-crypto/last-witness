/* LAST WITNESS - Legacy Compatibility Shim + Runtime Bootstrap 0.18.1
...
script("js/engine/15-thai-localization.js?v=0152","lwThaiLocalizationScript",()=>Boolean(window.LastWitnessThaiLocalization?.version==="0.15.2"&&window.LastWitnessThaiLocalization?.installed))
 ...
 .then(()=>{
  stylesheet("css/chapter-04-phase-05.css?v=0181","lwChapter04Phase05Style");
  return script(
   "js/chapters/chapter-04/05-north-is-marked.js?v=0181",
   "lwChapter04Phase05Script",
   ()=>Boolean(window.LastWitnessChapter4Phase5?.version==="0.18.1")
