/* LAST WITNESS - Legacy Compatibility Shim + Runtime Bootstrap 0.19.3
...
window.LastWitnessRuntimeBuild="0.19.3";
...
script("js/engine/15-thai-localization.js?v=0152","lwThaiLocalizationScript",()=>Boolean(window.LastWitnessThaiLocalization?.version==="0.15.2"&&window.LastWitnessThaiLocalization?.installed))
 ...
 .then(()=>{
  stylesheet("css/chapter-04-phase-06.css?v=0193","lwChapter04Phase06Style");
 ...
 .then(()=>script("js/chapters/chapter-04/06-false-success-portrait-assets.js?v=0193","lwChapter04Phase06PortraitAssets",()=>Boolean(window.LastWitnessPhase6PortraitAssets)))
 ...
 .then(()=>script("js/chapters/chapter-04/06-false-success.js?v=0193","lwChapter04Phase06Script",()=>Boolean(window.LastWitnessChapter4Phase6?.version==="0.19.3")).catch(error=>console.error("LAST WITNESS The False Success failed to load",error)))
 ...
 .then(()=>script("js/engine/25-runtime-build-label.js?v=0193","lwRuntimeBuildLabelScript",()=>Boolean(window.LastWitnessRuntimeBuildLabel?.version==="0.19.3"&&window.LastWitnessRuntimeBuildLabel?.installed)).catch(error=>console.error("LAST WITNESS Runtime Build Label failed to load",error)))
