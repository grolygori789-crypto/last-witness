/* LAST WITNESS - Legacy Compatibility Shim + Runtime Bootstrap 0.17.5
 ...
 * followed by the owner-approved character discovery repair 0.17.5,
...
script("js/engine/15-thai-localization.js?v=0152","lwThaiLocalizationScript",()=>Boolean(window.LastWitnessThaiLocalization?.version==="0.15.2"&&window.LastWitnessThaiLocalization?.installed))
 ...
 .then(()=>script(
  "js/engine/20-character-journal-story-gate.js?v=0175",
  "lwCharacterJournalStoryGateScript",
  ()=>Boolean(window.LastWitnessCharacterJournalStoryGate?.version==="0.17.5"&&window.LastWitnessCharacterJournalStoryGate?.installed)
 ...
 .then(()=>{
  stylesheet("css/chapter-04-phase-04-revision.css?v=0174","lwChapter04Phase04RevisionStyle");
  return script(
   "js/chapters/chapter-04/04a-arman-encounter-revision.js?v=0175",
   "lwChapter04Phase04RevisionScript",
   ()=>Boolean(window.LastWitnessChapter4Phase4Revision?.version==="0.17.5"&&window.LastWitnessChapter4Phase4Revision?.installed)
